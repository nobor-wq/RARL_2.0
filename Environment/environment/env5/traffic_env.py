...
class Traffic_Env(gym.Env):
    ...
    def raw_obs(self, vehicle_params):  # dimension: 24+5
        ...
        if self.AutoCarID in vehicle_params:
            ...
            info = {'x_position': ego_veh_x, 'y_position': ego_veh_y, 'cost': 0.0, 'infraction': 0.0,
                    'infraction_check': False, 'navigation_check': False}
            ...
            info = {'x_position': 0.0, 'y_position': 0.0, 'cost': 0.0, 'infraction': 0.0,
                    'infraction_check': False, 'navigation_check': False}
