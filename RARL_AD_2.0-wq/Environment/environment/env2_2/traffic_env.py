...
config_path = os.path.dirname(__file__)+"/../../../Environment/environment/env2_2/Intersection_2.sumocfg"  # Right turn at an intersection with crossing traffic
...
class Traffic_Env(gym.Env):
    ...
    def obs_to_state(self, vehicle_params):
        ...
        # only work for attack scenarios
        if self.attack:
